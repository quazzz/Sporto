...
export default function ExerciseCardDashboard({ name, gifUrl, bodypart, target, equipment, reps, sets, id, kg }) {
  ...
  return (
    <div className="max-w-xs sm:max-w-sm rounded overflow-hidden shadow-lg bg-white p-4 m-4 text-center relative">
      ...
      <p className="text-gray-800 text-base mb-1">Weight: {kg} kg</p>
