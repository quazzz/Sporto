...
export default function GroupCard() {
  ...
  <div className="max-w-md w-full space-y-8">
    <div className="text-center">
      <h1 className="text-4xl font-extrabold text-gray-900">Create New Group</h1>
      <p className="mt-2 text-sm text-gray-600">
        Organize your workouts and goals
      </p>
    </div>
    <form className="bg-white shadow-lg rounded-lg px-8 py-10 transition-all transform  hover:shadow-xl duration-200 ease-in-out">
      <div className="mb-6">
