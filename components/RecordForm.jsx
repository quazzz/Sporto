...
export default function RecordForm({handleAdd}) {
  ...
  return (
    <>
        ...
        <div className="w-full animate-fade-in flex rounded-xl justify-center items-start bg-gradient-to-b from-gray-900 to-black py-12 px-4 sm:px-6 lg:px-8 relative">
