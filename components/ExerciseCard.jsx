...
export default function ExerciseCard({ workout, onPlusClick, onViewDetailsClick }) {
  ...
  return (
    <div className="h-auto max-w-sm sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl rounded-lg animate-fade-in overflow-hidden shadow-xl bg-gradient-to-b from-blue-900/30 to-black   p-6 m-4 text-center transform transition-transform duration-300 hover:scale-105 animate-fade-in">
    ...
    <div className="mt-6 flex justify-center gap-4">
      <button
        ...
        className="transition-all bg-gradient-to-b from-indigo-500 to-indigo-600  text-white font-bold py-2 px-6 rounded-md shadow-sm"
      >
        View Details
      </button>
      <button
        type="button"
        onClick={onPlusClick}
        className="transition-all bg-gradient-to-b from-indigo-500 to-indigo-600    text-white font-bold py-2 px-4 rounded-full shadow-sm"
      >
        +
      </button>
    </div>
